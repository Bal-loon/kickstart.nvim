...
-- Set up the leader key, default is '/' so I don't want to change it
vim.g.mapleader = ' '
...
-- Some extra informatin abuot the file showed in the bottom
...
-- TODO show move below configs to new file
